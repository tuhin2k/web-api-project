const makeTable = function(){
    ...
    fetch('http://localhost:3001/seeallorders',{
            method: 'GET',
            credentials : 'include',
            headers: {
        ...
        .then(data => {
            ...
            setTimeout(()=>{
                ...
                data.forEach(element => {
                    ...
                    if(temp[4] != "pending")t_string='dead'

                    temp[5] = `<input type="button" class="payseller ${t_string}" id="${temp[2]}" name="" value="Pay Seller" >`
...
$(document).click(function(event){
    ...
    fetch('http://localhost:3001/payseller',{
        method: 'POST',
        credentials : 'include',
        headers: {
            'Content-Type': 'application/json'
